...
export function buildCurbCompatibilityMap() {
    const map = new Map();
    ...
    for (const model of models) {
        ...
        if (!rtu || !rtu.curb_L || !rtu.curb_W || !rtu.curb_H)
            continue;
...
export function findCompatibleCurbs(modelNumber) {
